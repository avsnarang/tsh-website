...
export const metadata: Metadata = {
  ...
  description: "Join The Scholars' Home for world-class education and holistic development. CBSE-affiliated school with three campuses offering pre-primary to senior secondary education.",
  keywords: ["The Scholars' Home", "CBSE school", "Paonta Sahib", "education", "primary school", "secondary school", "senior secondary"],
