...
export const campusInfo: { [key: string]: CampusInfo } = {
  paontaSahib: {
    ...
    heroImage: "https://images.tsh.edu.in/campus/paonta-sahib.jpg",
  ...
  juniors: {
    ...
    heroImage: "https://images.tsh.edu.in/campus/juniors.jpg",
  ...
  majra: {
    ...
    heroImage: "https://images.tsh.edu.in/campus/majra.jpg",
