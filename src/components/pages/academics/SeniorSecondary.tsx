              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <ScrollReveal key={index} delay={0.3 + index * 0.1}>
                    ...
                    >
                      <div className="absolute inset-0 bg-linear-to-br from-primary-light/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      <div className="relative">
                        <div className="w-12 h-12 bg-linear-to-br from-primary-light to-primary rounded-full flex items-center justify-center mx-auto mb-3">
                      ...
                      <ul className="space-y-3">
                        {level.focus.map((item, idx) => (
                          <TextReveal key={idx} delay={0.3 + idx * 0.1}>
                            ...
                            >
                              <div className="w-6 h-6 bg-linear-to-br from-primary-light to-primary rounded-full flex items-center justify-center">
